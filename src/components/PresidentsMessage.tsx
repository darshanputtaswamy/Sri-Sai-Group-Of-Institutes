...
export function PresidentsMessage() {
    return (
        <div>
            <BackgroundGradient className="rounded-[22px] h-[25rem] flex  p-4 sm:p-10 bg-white dark:bg-zinc-900">
       
                <div className="p-4 mt-6">
                    <p className="text-base sm:text-xl text-black mt-20 mb-2 dark:text-neutral-200">
